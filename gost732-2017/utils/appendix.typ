...
#let appendix(l: none, toc: none, letter: none, first-page-content: none, own-numbering: true, content) = {
    if l != none { letter = l }
...
#let приложение(б: none, содержание: none, буква: none, контент-первой-страницы: none, собственная-нумерация: true, content) = appendix(l: б, toc: содержание, letter: буква, first-page-content: контент-первой-страницы, own-numbering: собственная-нумерация, content)
